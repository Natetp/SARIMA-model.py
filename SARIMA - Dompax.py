...
excel_file = "D:\CBKT LTIA\Ban CBKT CHKQT Long Thanh\Data analyst\LTIA Forecast\SGN_LTIA_forecastpax - Dom.xlsx"
df = pd.read_excel(excel_file, index_col=0)
df = df.asfreq('MS')
df.rename(columns= {'Dom_pax': 'Monthly Pax'},inplace=True)
print(df.head(132))
...
# PACF (p) and ACF (q) Plot: (1st Order Differencing)
...
#Building SARIMA(p,d,q) = (2, 1, 2) (0, 1, 1, 12) AIC = 2968
...
future = model_fit.get_forecast(steps=60, signal_only=False)
